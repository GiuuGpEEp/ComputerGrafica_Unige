...
public:
    DiscardController();
    void start(std::vector<Card>&& cards, sf::Vector2f graveyardCenter, int ownerIdx = -1, float duration = 0.45f);
    // Resetta lo stato interno cancellando animazioni e carte pendenti
    void reset();
    bool active() const;
