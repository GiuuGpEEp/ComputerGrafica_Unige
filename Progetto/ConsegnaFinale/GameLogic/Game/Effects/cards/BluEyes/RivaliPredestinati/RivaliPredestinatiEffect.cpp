...
// Helper locale: controlla se il proprietario controlla BEWD o Mago Nero
// Nota: usiamo Game& (non-const) per poter accedere a getTurn() non-const senza modificare stato
static bool controlsRequiredBoss(Game& game, int ownerIdx) {
