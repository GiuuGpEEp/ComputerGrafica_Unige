...
// più una piccola funzione per precaricare le texture più comuni.
namespace AppConfig {
    ...
    inline constexpr float OpponentHandTopMarginPx = 14.f;// margine superiore per la Y della mano dell'avversario (più vicino al bordo)
    inline constexpr float OpponentHandScaleFactor = 0.85f; // fattore di scala per la mano dell'avversario
