...
Il progetto finale si trova in: `Progetto/ConsegnaFinale`. Questo README fornisce una panoramica ordinata della struttura e dei principali componenti per agevolare la valutazione.
...
- Wiring app↔motore: `ConsegnaFinale/GameWiring/`
