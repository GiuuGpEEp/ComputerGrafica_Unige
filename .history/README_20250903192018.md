...
- GameWiring/
  - Inizializza il Game per la logica di gioco, collegando i vari handler degli eventi, registrando effetti dei mostri sincronizza stato logico ↔ UI (apertura prompt, overlay, aggiornamento grafico).
