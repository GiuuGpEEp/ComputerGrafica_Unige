...
bool Game::resolvePendingSendFromDeck(size_t indexInFiltered){
    ...
    // La UI deve passare un indice già filtrato alle carte valide; qui per semplicità
    // assumiamo che l'UI selezioni tramite nome e chiami removeFirstByName esternamente.
    // Per ora, questa API non usa l'indice e fallisce: lasciamo lo stub per compatibilità futura.
