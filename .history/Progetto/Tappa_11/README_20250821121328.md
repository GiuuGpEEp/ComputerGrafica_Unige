...
Per far ciò ho modificato la classe game, aggiungendo il cimitero (e un metodo per farne la get) e un metodo discartExcess, oltre a un metodo per ottenere il vettore di carte che sono state scartate con lo scopo di 