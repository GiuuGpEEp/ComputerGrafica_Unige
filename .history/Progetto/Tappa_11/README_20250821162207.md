...
**Metodo moveCard**
All'interno della classe Game ho implementato il metodo moveCard. Questo metodo prende in input una zona di source (da dove viene la carta), e una zona di destinazione. Questo metodo permette di rendere molto più efficente 