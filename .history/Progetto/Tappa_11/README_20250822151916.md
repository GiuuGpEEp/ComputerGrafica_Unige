...
Aggiunto nel main anche la visualizzazione di una carta dummy nel campo dell'avversario, per testare se funziona il target di attacco. Ho aggiunto anche quindi un metodo di debug in per aggiungere questo mostro
