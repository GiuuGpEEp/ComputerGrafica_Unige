...
- create le variabili per la gestione, ovvero:  
    ...
    * tributesNeeded
- Creata la logica di selezione --> Nella parte dove selezionavamo le carte sul campo ho aggiunto la possibilità che, se il flag di selezione è true cerco all'interno degli indici già aggiunti se la carta cliccata (con indice i) è presente. Se non lo è aggiungo. Una volta che ho raggiunto il numero di tributi     