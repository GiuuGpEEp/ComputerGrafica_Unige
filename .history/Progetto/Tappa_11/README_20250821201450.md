...
L'evocazione resta in pausa finche il flag selectingTributes è true. Una volta che il numero di tributi è stato raggiunto viene chiamato `completePendingNormalSummon`