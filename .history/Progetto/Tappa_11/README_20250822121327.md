...
- Modifica in **Game**, qui implementiamo la logica effettiva della BattlePhase
	...
	* Aggiunta anche dei metodi helper `dealDamageTo`, che chiama damage e infligge danno (emissione evento), e `destroyMonster` che si occupa di spostare il mostro dal terreno al cimitero e fare un'emit dell'evento CardSentToGrave e MonsterDestroyed.       	