...
/**
 * Controlla se una posizione del mouse è sopra uno slot valido per una carta
 * @param mousePos Posizione del mouse
 * @param card Carta che si sta trascinando
 * @param field Campo di gioco
 * @param slotSize Dimensioni degli slot
 * @return true se la posizione è valida per quella carta, false altrimenti
 */
 ...
 */
sf::Vector2f findNearestSlotPosition(sf::Vector2f mousePos, const Card& card, const Field& field, const sf::Vector2f& slotSize);
