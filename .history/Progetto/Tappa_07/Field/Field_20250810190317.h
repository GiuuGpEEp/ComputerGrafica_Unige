...
public:
    ...
    // Metodi per gestire l'occupazione degli slot
    bool setSlotOccupied(Type slotType, int player, int slotIndex, bool occupied);
    bool isSlotOccupied(Type slotType, int player, int slotIndex) const;
    int findFreeSlotIndex(Type slotType, int player) const; // Trova il primo slot libero
