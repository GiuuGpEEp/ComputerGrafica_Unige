...
**Modifica della classe Field** --> Aggiunta di un metodo che permette, partendo dalla posizione, di avere un puntatore ad uno slot, in questo modo riusciamo ad accedere allo slot effettivo e ad utilizzare i suoi metodi per modif
