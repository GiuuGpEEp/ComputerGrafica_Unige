...
- Questa è una funzione optional, quindi può avere un valore o essere nulla, e ci restituisce la posizione dello slot. Viene utilizzata per far si che, se quando lasciamo la carta quest'ultima è nei pressi di  uno slot valido allora recuperiamo la posizione essatta di quello 
