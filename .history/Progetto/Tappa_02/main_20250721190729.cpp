...
int main() {
    ...
    cards.emplace_back("Mago Nero", "Il piu' potente tra i maghi per abilita' offensive e difensive.", 2500, 2000, sf::Vector2f(200, 50), textureNonFlipped);

    // Inizializzo la finestra di rendering
    sf::RenderWindow window(sf::VideoMode({1920, 1080}), "Progetto Tappa 02");
            ...
            if (const auto *mouseButton = event->getIf<sf::Event::MouseButtonPressed>()) {
                ...
                if(but == sf::Mouse::Button::Left) {
                    ...
                    if (!cardClicked) {
                        ...
                        scrollOffset = 0.f; // Resettando lo scroll quando seleziono fuori (o un'altra carta) 
                    }
                }
            }
