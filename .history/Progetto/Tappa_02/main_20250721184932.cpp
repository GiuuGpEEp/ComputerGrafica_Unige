...
int main() {
    ...
    while(window.isOpen()){
        ...
        if (selectedCardIndex.has_value()) {
            ...
            // Creo la stringa con il testo principale (scrollabile)
            ...
            // Testo ESC (fisso)
            std::string escText = "Premi ESC per chiudere";
            ...
            // Partendo dalla stringa originale, dopo averne fatto il wrapping, creo l'effettivo oggetto Text (il testo )
            ...
            sf::Text escTextObj(detailFont, escText, 12);
