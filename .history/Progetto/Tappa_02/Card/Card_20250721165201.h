...
class Card {
public:
    Card(const std::string& name, const std::string& description, int atk, int def, sf::Vector2f pos, bool flipped = false);
...
private:
    ...
    sf::Sprite sprite(../../Progetto/resources/CardNotSet.png);
    sf::Font font;
