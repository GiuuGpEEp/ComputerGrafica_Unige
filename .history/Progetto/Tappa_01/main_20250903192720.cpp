...
int main() {
    ...
    cards.emplace_back("Drago Bianco", "Drago leggendario ...", 3000, 2500, sf::Vector2f(50, 50));
    cards.emplace_back("Mago Nero", "Mago noto per le sue doti magiche", 2500, 2000, sf::Vector2f(200, 50));
