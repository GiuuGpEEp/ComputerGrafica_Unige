...
int main(){
    ...
    // (Ritorno alla Home ora gestito automaticamente al termine del fade out della DeckSelection)
        ...
        if(returnPopupActive){
            ...
            title.setPosition(center.x, popupPos.y + 70.f);
            window.draw(title);
            ...
            hint.setPosition(center.x, popupPos.y + popupSize.y - 80.f);
            window.draw(hint);
            ...
            sf::Text yesT(detailFont, "SI", 30); sf::FloatRect yb = yesT.getLocalBounds(); yesT.setOrigin(sf::Vector2f(yb.size.x/2.f, yb.size.y/2.f)); yesT.setPosition(yesBtn.getPosition()+btnSize/2.f); window.draw(yesT);
            sf::Text noT(detailFont, "NO", 30); sf::FloatRect nb = noT.getLocalBounds(); noT.setOrigin(sf::Vector2f(nb.size.x/2.f, nb.size.y/2.f)); noT.setPosition(noBtn.getPosition()+btnSize/2.f); window.draw(noT);
        }
