...
bool ResourceManager::initialize(const sf::Vector2f& deckSlotPos,const sf::Vector2f& deckSlotPos. const sf::Vector2f& deckCardSize, const sf::Vector2f& slotSize, sf::Texture& textureFlipped) {
    try {
