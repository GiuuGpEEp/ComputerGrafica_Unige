...
int main(){
    ...
    bool pendingHomeReturn = false; // (non più usato per timeout, ma lasciato per retrocompatibilità)
    sf::Clock selectionReturnClock; // (può essere rimosso a refactor completato)
    ...
    // Ritorno gestito da fadeOut completion
