...
**Aggiunta a Field** --> ggiunto parametro enableHover a Field::draw e la chiamata in main.cpp ora lo imposta a false quando extraOverlay.isOverlayVisible() è vero, così gli slot non evidenziano al passaggio mentre l’overlay è aperto. 
