...
int main(){
    ...
    bool holdingExtraDeck = false;            // true mentre tengo premuto sullo stack extra
    bool showExtraPreview = false;            // mostra overlay
    ...
    while(window.isOpen()){
        ...
        while (const std::optional event = window.pollEvent()){
            ...
            if (const auto *mouseButton = event->getIf<sf::Event::MouseButtonReleased>()) {
                sf::Mouse::Button but = mouseButton->button;
                if(but == sf::Mouse::Button::Left) {
                    // Fine hold extra deck
                    if(holdingExtraDeck){
                        holdingExtraDeck = false;
                        showExtraPreview = false; // nascondo quando rilascio
                    }
