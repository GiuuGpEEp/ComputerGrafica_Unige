    ...
    if(gamestate == GameState::Playing){
        ...
        if(gamestate == GameState::HomeScreen){
            ...
            if(showExtraPreview && deck.getExtraSize() > 0){
                ...
                float previewScale = 0.9f; // dimensione rispetto alla carta base (cardSize usata per mano)
                ...
                sf::Vector2f origin((windowSize.x - gridWidth)/2.f, windowSize.y * 0.62f - gridHeight); // davanti al giocatore, sopra la mano
                ...
                for(int i=0; i<total; ++i){
                    ...
                    // Copia leggera per non modificare card originale (solo posizione e size)
                ...
                sf::Text hint(detailFont, "Rilascia il tasto per chiudere", 16);
