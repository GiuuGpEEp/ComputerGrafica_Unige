...
public:
    ...
    void draw(sf::RenderWindow& window, const sf::Vector2i& mousePos, GameState gamestate, bool enableHover = true) const;
    ...
    Slot* getSlotByPosition(sf::Vector2f position, float tolerance = 50.0f);
