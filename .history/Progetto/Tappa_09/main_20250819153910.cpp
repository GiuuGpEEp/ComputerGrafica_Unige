...
int main(){
    ...
    // (Ritorno alla Home ora gestito automaticamente al termine del fade out della DeckSelection)
        ...
        if(returnPopupActive){
            ...
            noButton.setFillColor(sf::Color(170,60,60));
            window.draw(yesButton); window.draw(noButton);
            ...
            noT.setPosition(noButton.getPosition()+sf::Vector2f(btnSize.x/2.f, btnSize.y/2.f)); 
            window.draw(noT);
        }
