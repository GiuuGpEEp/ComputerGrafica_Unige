        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    slots.emplace_back(sf::Vector2f(leftX, p1MonsterY), extraDeckTexture, Slot::Type::Extra, slotSize);
    slots.emplace_back(sf::Vector2f(leftX, p1SpellY), fieldSpellTexture, Slot::Type::FieldSpell, slotSize);

    slots.emplace_back(sf::Vector2f(leftX, p2MonsterY), fieldSpellTexture Slot::Type::Field, slotSize);
    slots.emplace_back(sf::Vector2f(leftX, p2SpellY), fieldSpellTexture, Slot::Type::FieldSpell, slotSize);
}
