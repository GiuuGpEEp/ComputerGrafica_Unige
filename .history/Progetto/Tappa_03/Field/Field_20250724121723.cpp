...
void Field::createRotatedTexture(const sf::Texture& original, sf::Texture& rotated) {
    ...
    Mentre le texture normali sono solo delle immagini da caricare, le renderTexture sono delle texture speciali su cui si può disegnare, ciò permette di applicare trasformazioni ad un immagine per poi riusarla come texture*/
