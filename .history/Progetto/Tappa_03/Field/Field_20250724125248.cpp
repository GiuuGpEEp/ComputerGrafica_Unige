        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    slots.emplace_back(sf::Vector2f(rightX, p1MonsterY), graveyardTexture, Slot::Type::Deck, slotSize);
    slots.emplace_back(sf::Vector2f(rightX, p1SpellY), deckTexture, Slot::Type::Graveyard, slotSize);
