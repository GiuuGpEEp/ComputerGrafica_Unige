        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    createRotatedTexture(graveyardTexture, rotatedFieldSpellTexture);

    slots.emplace_back(sf::Vector2f(leftX, p2MonsterY), fieldSpellTexture, Slot::Type::Graveyard, slotSize);
    slots.emplace_back(sf::Vector2f(leftX, p2SpellY), rotatedDeckTexture, Slot::Type::Deck, slotSize);
}
