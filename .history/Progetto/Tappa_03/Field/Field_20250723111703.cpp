        ...
        ) : background(fieldTexture) 
{
    ...
    const float slotWidth = monsterTexture.getSize().x; //In questo caso prendo uso getSize e non getTextureRect perche' sto prendendo la dimensionde direttamente dalla texture, mentre prima dallo spite 
