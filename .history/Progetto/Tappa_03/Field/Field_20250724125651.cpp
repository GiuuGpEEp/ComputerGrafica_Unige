        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    slots.emplace_back(sf::Vector2f(leftX, p2MonsterY), rotatedGraveyardTexture, Slot::Type::Graveyard, slotSize);
    slots.emplace_back(sf::Vector2f(leftX, p2SpellY), rotatedGraveyardTexture, Slot::Type::Deck, slotSize);
}
