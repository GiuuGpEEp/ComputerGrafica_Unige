...
sf::Texture Field::createRotatedTexture(const sf::Texture& original) {
    ...
    static sf::RenderTexture renderTexture;  // Static per evitare problemi di lifetime
    ...
    // Renderizza lo sprite ruotato su sfondo rosso per debug
    renderTexture.clear(sf::Color::Red);  // Cambiato da Transparent a Red per debug
    renderTexture.draw(sprite);
    renderTexture.display();
    
    // Crea una nuova texture e copia il contenuto
    sf::Texture rotated;
    sf::Image tempImage = renderTexture.getTexture().copyToImage();
    rotated.loadFromImage(tempImage);
