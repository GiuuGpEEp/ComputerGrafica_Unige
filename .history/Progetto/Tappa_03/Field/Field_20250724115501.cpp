        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    sf::Transform monsterTransform;
    monsterTransform.rotate(180.f, monsterTexture.getSize().x / 2.f, monsterTexture.getSize().y / 2.f);
    ...
    rotatedMonsterSprite.setRotation(180.f);
