...
private:
    ...
    sf::RenderTexture renderTexture;  //Mentre le texture normali sono solo delle immagini da caricare, le renderTexture sono delle texture speciali su cui si puù disegnare, ciò permette di applicare trasformazioni ad un immagine per poi riusarli 
