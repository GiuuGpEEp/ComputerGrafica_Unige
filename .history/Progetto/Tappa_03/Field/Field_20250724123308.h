...
private:
    ...
    // Texture ruotate create una volta sola
    ...
    sf::Texture createRotatedTexture(const sf::Texture& original, float degrees = 180.0f) const; // Crea texture ruotata generica
    void createRotatedTextures(const sf::Texture& monsterTexture, const sf::Texture& spellTrapTexture); // Crea tutte le texture ruotate
};
