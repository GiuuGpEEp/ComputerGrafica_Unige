...
### Reset di ogni flag post fine partita per evitare input bloccati e altro 
Cambiata unicamente la lambda resetMatch() in main, ora vengono reinizializzate più cose