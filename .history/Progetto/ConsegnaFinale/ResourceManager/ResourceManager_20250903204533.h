...
class ResourceManager {
    ...
    public:
        ...
        bool initialize(const sf::Vector2f& deckSlotPos, const sf::Vector2f& extraDeckSlotPos, const sf::Vector2f& deckCardSize, const sf::Vector2f& slotSize, sf::Texture& textureFlipped);
    ...
    std::unordered_map<std::string, Deck> availableDecks; // Cambiato da vector a unordered_map
        ...
        void loadDecksFromJson(const std::string& decksJsonPath, const sf::Vector2f& deckSlotPos, const sf::Vector2f& extraDeckSlotPos, const sf::Vector2f& deckCardSize, const sf::Vector2f& slotSize, sf::Texture& textureFlipped);
