...
struct Context {
    ...
    // Per scelte che mostrano una lista filtrata diversa dalla sorgente (es. Cimitero -> solo mostri)
    // Consente di passare alla UI una mappatura dagli indici mostrati a quelli reali nella fonte.
...
// per vivere più a lungo delle sottoscrizioni.
