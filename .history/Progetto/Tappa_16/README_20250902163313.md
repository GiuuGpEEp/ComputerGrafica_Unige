...
- **La Melodia del Drago che si Risveglia**
	...
	- Cosa è stato aggiunto/modificato nei file
      ...
      - `requestHandDiscard(int ownerIdx)`: apre la scelta di scarto per l'owner, emettendo HandDiscardChoiceRequested (delegando quindi il lavoro all'App Handler); fallisce se la mano è vuota o già occupata da un'altra scelta.
