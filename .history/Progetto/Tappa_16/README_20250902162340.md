...
- **La Melodia del Drago che si Risveglia**
	...
	- Cosa è stato aggiunto/modificato nei file
      ...
      - `requestHandDiscard(int ownerIdx)`: apre la scelta di scarto per l'owner, emettendo HandDiscardChoiceRequested; fallisce se la mano è vuota o già occupata da un'altra scelta.
      ...
      - hasPendingAddFromDeck() const: true se c'è una scelta di aggiunta dal Deck in corso. - resolvePendingAddFromDeck(size_t idx): aggiunge alla mano la carta selezionata dalla lista candidati; decrementa il contatore e, se rimangono scelte, riapre la lista; altrimenti chiude.
