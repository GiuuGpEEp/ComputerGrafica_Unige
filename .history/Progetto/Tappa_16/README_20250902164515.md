...
- **La Melodia del Drago che si Risveglia**
	...
	- Cosa è stato aggiunto/modificato nei file
      ...
      - `resolvePendingHandDiscard(size_t handIndex)`: scarta la carta selezionata dalla mano al Cimitero, chiude la scelta di scarto e, se pianificato avvia un qualcosa post scarto come per esempio avvia la scelta dal Deck per Melodia.
