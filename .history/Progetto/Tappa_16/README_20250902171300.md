...
- **Richiamo del Posseduto (semplificato)**
	...
	- Cosa è stato aggiunto/modificato nei file
		...
		- Progetto/Tappa_16/AppHandlers/AppHandlers.h, AppHandlers.cpp
			...
			- Aggiunto handler GraveyardChoiceRequested: P2 (AI) auto-pick tra i Mostri; P1 (umano) apertura overlay con candidati filtrati ai soli Mostri e mappatura indici UI → indici reali nel Cimitero.
