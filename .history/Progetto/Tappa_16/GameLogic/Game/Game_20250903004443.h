...
private:
    ...
    int attackerOwner = -1;      // indice giocatore attaccante (0/1)
    int attackerSlotIndex = -1;  // indice slot mostro attaccante
    int defenderOwner = -1;      // indice giocatore difensore (0/1)
    int defenderSlotIndex = -1;  // indice slot mostro difensore
};
