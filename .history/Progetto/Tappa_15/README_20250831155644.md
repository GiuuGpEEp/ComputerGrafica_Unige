...
- Problema risolto: quando un giocatore scartava, le carte venivano talvolta inserite nel `graveyard` del giocatore sbagliato (logica). Ho quindi aggiunto un getter che permette di accedere al graveyard in base al proprietario e ho reso il controller delle animazioni dei discard .
