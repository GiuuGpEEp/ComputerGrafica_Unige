...
- Modificato rompt di risposta: si apre dopo ogni attivazione (eventi `SpellActivated`/`TrapActivated`) e mostra SOLO le carte attivabili del giocatore locale (P1), ossia Magie Rapide/Trappole che rispettano il timing.
