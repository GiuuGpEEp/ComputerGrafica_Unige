...
- Correzione effetto `Pietra bianca della leggenda`:
 ...
 - Comportamento `Reliquiario del Drago` (Deck send choice):
    ...
    - Miglioramenti futuri possibili: sostituire la scelta casuale AI con una euristica (es. rimuovere Drago con ATK più basso/alto), oppure rendere il seed RNG configurabile per test riproducibili.
