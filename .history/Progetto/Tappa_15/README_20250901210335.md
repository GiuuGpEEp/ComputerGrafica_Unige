...
- EffectSystem
  - Aggiunta un `activationChain` (stack con tutti le `ActivationRequest`). `resolveAllActivations(Game&)` risolve dalla cima verso il basso chiamando `IActivationEffect::resolve(...)` nell’ordine inverso.
