...
- Game
  ...
  - Modificato `activateSpellFromHand(...)`: per carte non-continue con `IActivationEffect`, al posto di chiamare usa `startChainWithActivation` e sposta la carta al Cimitero; niente `resolve()` immediato.
- EffectSystem
