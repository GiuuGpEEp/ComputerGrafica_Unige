...
- Adesso quando attivo delle carte dalla mano non viene chiamatao subito risolve. Prima di risolvere il loro effetto infatti vengono aggiunte alla catena con `startChainWithActivation(...)` (aggiunge un elemento al vector ) e la carta viene spostata nel Cimitero; la risoluzione avviene quando la catena si chiude.
