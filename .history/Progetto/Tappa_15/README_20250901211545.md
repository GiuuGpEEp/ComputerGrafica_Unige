...
- EffectSystem
  ...
  - `resolveTopActivations(Game&)` Prendo il primo effetto da attivare (quello in fondo) e dopo aver fatto dei controlli (superflui, ma per sicurezza) chiama il metodo resolve() su quell
