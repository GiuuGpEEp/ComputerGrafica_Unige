...
struct Context {
    ...
    std::function<std::vector<Card>()> getGraveyardCards;   // sorgente Cimitero corrente (P1)
    std::function<std::vector<Card>()> getOpponentGraveyardCards; // sorgente Cimitero avversario (P2)
