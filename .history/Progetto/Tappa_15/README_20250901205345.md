...
- Modificato il prompt di risposta: Adesso dopo ogni giocata di mostro, cambio fase e si apre dopo ogni attivazione (eventi `SpellActivated`/`TrapActivated`) e mostra SOLO le carte attivabili del giocatore locale (P1), ossia Magie Rapide/Trappole che rispettano il timing.
