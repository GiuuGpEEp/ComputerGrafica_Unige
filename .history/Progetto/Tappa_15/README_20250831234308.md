...
- Correzione effetto `Pietra bianca della leggenda`:
 ...
 - Comportamento `Reliquiario del Drago` (Deck send choice):
    ...
    - Dettagli tecnici:
      ...
      - Dopo che la carta Drago è mandata al Cimitero con `resolvePendingSendFromDeck`, Reliquiario stesso viene spostato dalla Spell/Trap Zone al Cimitero tramite il flusso esistente.
