...
- EffectSystem
  - Aggiunta un `activationChain` (stack). `resolveAllActivations(Game&)` risolve dalla cima verso il basso chiamando `IActivationEffect::resolve(...)` nell’ordine inverso.
