...
- EffectSystem
  ...
  - `pushActivationRequest()` Fa la push back di un elemento all'interno dello stack --> (metodo che viene chiamato all'interno di `startChainWithActivation(const std::string&, int)`)
