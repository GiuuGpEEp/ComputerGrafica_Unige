...
- Adesso quando attivo delle carte dalla mano non viene chiamatao subito risolve. Vengono aggiunte alla catena con `startChainWithActivation(...)` e la carta viene spostata nel Cimitero; la risoluzione avviene quando la catena si chiude.
