...
- Graveyard overlay 
  - q l'overlay del cimitero relativo (bottom/top). L'overlay memorizza l'owner correntemente mostrato (`currentOwner`) e il `main` chiede le carte con `game->getGraveyardOf(owner)`.
