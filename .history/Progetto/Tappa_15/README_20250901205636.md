...
- Game
  ...
  - `playerPassOnChain(int)`: registra il pass del giocatore; se passano entrambi consecutivamente (non aggiungono altri effetti), chiude la chain e chiama `EffectSystem::resolveAllActivations(...)` (risoluzione LIFO).
