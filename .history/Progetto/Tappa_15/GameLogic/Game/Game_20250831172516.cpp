...
bool Game::activateSetSpellTrapFor(int playerIdx, size_t zoneIndex){
    ...
    // Turno avversario: per il regolamento locale consentiamo solo Magie Rapide
    if(!isQuick) return false; // solo Quick spells
...
bool Game::canActivateSetSpellTrapFor(int playerIdx, size_t zoneIndex){
    ...
    // Turno avversario: solo Magie Rapide sono considerate attivabili
