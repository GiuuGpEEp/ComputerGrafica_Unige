...
void Game::mirrorExternalDeckRemoveByName(const std::string& name, const Deck* sourceDeck){
    ...
    // Evita di rimuovere due volte la stessa carta se l'externalDeck e' la stessa istanza del deck sorgente
    if(sourceDeck && sourceDeck == externalDeck){
        return; // gia' rimosso dalla sorgente
    }
