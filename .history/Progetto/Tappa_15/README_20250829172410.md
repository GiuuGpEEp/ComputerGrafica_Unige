...
### Obiettivo
- Risolvere discrepanze tra lo stato logico del gioco e la rappresentazione UI dei Deck (conteggio carte, condizioni di deck-out).
- Evitare residui grafici (texture/overlay) tra partite successive.

### Modifiche principali (comportamentali)
