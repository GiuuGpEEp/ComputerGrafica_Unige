...
- Overlay Cimitero: aggiunta la possibilità di tener premuto sullo slot cimitero dell'avversario per aprire l'overlay che mostra il suo graveyard.
  ...
  - `InputController` gestisce la logica di  l'hit-test su entrambi i rect (bottom/top). Se il mouse è dentro lo slot top passa `owner=1`, se è dentro lo slot bottom passa `owner=0`.
