...
- Game
  ...
  - `playerPassOnChain(int)`: registra il pass del giocatore; se passano entrambi consecutivamente (non aggiungono altri effetti), chainActive viene marcato come false e viene chiamato `EffectSystem::resolveAllActivations(...)`.
