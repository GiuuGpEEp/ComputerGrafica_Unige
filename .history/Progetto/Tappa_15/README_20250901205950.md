...
- Game
  ...
  - Modificato `activateSpellFromHand(...)`: per carte non-continue con `IActivationEffect`, usa `startChainWithActivation` e sposta la carta al Cimitero; niente `resolve()` immediato.
- EffectSystem
