...
- Correzione effetto `Pietra bianca della leggenda`:
 ...
 - Comportamento `Reliquiario del Drago` (Deck send choice):
    ...
    Quindi quando viene attivata la magia l'effetto della carta (gestito nella cartella effects) richiama la funzione requestSendFromDeck in game, che scatenerà un evento di tipo DeckSendChoiceRequested e il tutto 
