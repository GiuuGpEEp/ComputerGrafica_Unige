...
- Correzione effetto `Pietra bianca della leggenda`:
 ...
 - Comportamento `Pietra bianca degli antichi` (Evocazione Speciale con scelta posizione):
 	...
 	- Modifica introdotta in Game: ho esposto un getter `Game::getPendingSpecialSummonOwner()` e ho aggiornato il gestore in `AppHandlers` che risponde a `SpecialSummonChoiceRequested`.
