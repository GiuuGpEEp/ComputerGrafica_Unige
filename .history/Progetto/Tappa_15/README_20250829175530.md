...
- `Game` modifica del metodo per associare il deck al gioco:
  ...
  - `Game::mirrorExternalDeckRemoveByName(const std::string&, const Deck*)` adesso La funzione riceve il `sourceDeck` per evitare "double-remove" quando la sorgente della rimozione è già la stessa istanza grafica.
