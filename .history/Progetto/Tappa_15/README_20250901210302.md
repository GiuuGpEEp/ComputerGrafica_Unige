...
- EffectSystem
  - Aggiunta un `activationChain` (stack con tutti gli eventi). `resolveAllActivations(Game&)` risolve dalla cima verso il basso chiamando `IActivationEffect::resolve(...)` nell’ordine inverso.
