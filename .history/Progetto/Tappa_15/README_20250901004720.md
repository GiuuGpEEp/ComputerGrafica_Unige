...
- WhiteStoneAncients: siccome capitava spesso che si confondessi chi fosse l'effettivo proprietario della pietra mandata al cimitero ho migliorato la determinazione del proprietario quando la `Pietra Bianca degli Antichi` viene mandata al cimitero.
