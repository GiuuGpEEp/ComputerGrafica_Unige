...
int main(){
    ...
    int cur = game->getTurn().getCurrentPlayerIndex();
    // Cerca prima le attivazioni disponibili per l'altro giocatore (ha priorita' sulle risposte)
    int other = 1 - cur;
    responseOwner = other;
    rebuildResponseActivables();
    // Se l'altro non ha nulla da attivare, considera il giocatore corrente (per chaining immediato)
