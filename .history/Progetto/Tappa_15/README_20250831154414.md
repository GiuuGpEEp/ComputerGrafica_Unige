...
## Fix recenti: discard -> graveyard e correzione animazioni
...
- Problema risolto: quando un giocatore scartava, le carte venivano talvolta inserite nel `graveyard` del giocatore sbagliato (logica). Ho reso l'accesso al cimitero esplicito per proprietario e ho reso il controller delle animazioni dei discard owner-aware.
