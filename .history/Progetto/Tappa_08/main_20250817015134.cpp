...
int main(){
    ...
    sf::Clock deckSelectClock;
    bool showDeckSelectedText = false;
            ...
            if (const auto *mouseButton = event->getIf<sf::Event::MouseButtonPressed>()) {
                ...
                if(but == sf::Mouse::Button::Left) {
                    ...
                    if(gamestate == GameState::DeckSelection){
                        ...
                        if (hoveredIdx != -1) {
                            deckSelectionScreen.setSelectedDeckIndex(hoveredIdx);
                            selectedDeckName = deckSelectionScreen.getSelectedDeckName();
                            showDeckSelectedText = true;
                            deckSelectClock.restart();
                        }
