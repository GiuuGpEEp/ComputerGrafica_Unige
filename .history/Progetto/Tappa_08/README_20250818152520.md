...
**Aggiunta di un'animazione per il caricamento del campo** --> Adesso dopo la pressione del tasto gioca nell'homeScreen non si passa più in FieldVisible, ma in FieldLoading, avviando un'animazione di caricamento. 