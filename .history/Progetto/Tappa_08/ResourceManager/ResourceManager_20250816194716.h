...
public:
    ...
    const std::unordered_map<std::string, Deck>& getAvailableDecks() const { return availableDecks; }
    ...
    bool hasDeck(const std::string& deckName) const { return availableDecks.find(deckName) != availableDecks.end(); }
