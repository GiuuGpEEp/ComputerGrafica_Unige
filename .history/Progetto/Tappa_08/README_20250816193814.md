...
Tramite l'inizializzazione del resourceManager tutti i deck e tutte le carte vengono quindi caricate, e tramite i metodi sempre del resou

**Modifica della Classe Deck** --> Ho aggiunto semplicemente i nomi ad ogni deck