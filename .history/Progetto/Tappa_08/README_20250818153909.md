...
Aggiunto anche il fatto che se si clicca gioca senza avere nessun deck selezionato non si può giocare, e una scritta che conferma il deck selezionato --> gestito dal booleano **showNoDeckWarning** (se è true disegno il testo)
...
All'interno del main viene quindi unicamente creato un oggetto di tipo **FieldLoading** che si occupa di far partire l'animazione.