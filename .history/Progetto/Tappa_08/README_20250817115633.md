...
**Modifica della gestione eventi nel deck** --> per far si di passare effettivamente alla SelectionScreen, e per far in modo che una volta selezionato un deck si tornasse alla home e in alto comparisse il nome del deck selezionato. Inoltre ho dovuto modificare 