...
void FieldLoadingAnimation::draw(sf::RenderWindow& window){
    ...
    // Cross-fade
    sf::Color homeColor = sf::Color::White; homeColor.a = static_cast<sf::uint8_t>(255 * (1.f - tt));
    sf::Color fieldColor = sf::Color::White; fieldColor.a = static_cast<sf::uint8_t>(255 * tt);
