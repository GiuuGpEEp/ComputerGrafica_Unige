...
**Modifica della Classe Deck** --> Ho aggiunto semplicemente i nomi ad ogni deck, AssimeCostruttore di copia: permette di creare un nuovo oggetto Deck copiando i dati da un altro oggetto Deck. Viene usato, ad esempio, quando scrivi Deck nuovoDeck = vecchioDeck; oppure quando una funzione restituisce un oggetto Deck per valore.
...
Nel tuo caso, sono necessari perché:
