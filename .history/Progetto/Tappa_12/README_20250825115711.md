...
- La stessa coerenza dei flag modificata e mantenuta in moveCard viene mantunata anche in: mantenuta in `moveCard`, `destroyMonster`, `tributeMonsters`, e `debugAddMonsterToOpponent`.
- API principali:
