...
Per implementare questa logica ho aggiunto un altro tipo di evento: `NormalSet` e fatto alcune modifiche in `Game`:
- Fatto un override del metodo `beginNormalSummonWithTributes`, in modo tale che accetti anche un booleano asSet (inizialmente false). 
