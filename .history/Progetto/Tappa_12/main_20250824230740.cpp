    ...
    // Gestione del sollevamento delle carte in mano
        ...
        if(gamestate == GameState::HomeScreen){
            ...
            for (size_t i=0;i<fieldCards.size();++i) {
                ...
                if(isFD){
                    fieldCardScale = 0.6;
                    drawCard.setSize(sf::Vector2f(slotSize.x * fieldCardScale, slotSize.y * fieldCardScale));
                ...
                if(isDef || isFD){
                    ...
                    // Target size for rotated card (width = slot height, height = slot width), scaled down
                    sf::Vector2f rotatedSize(slotSize.y * 0.70f, slotSize.x * 0.70f);
