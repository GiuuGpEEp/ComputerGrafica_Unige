            ...
            for (size_t i=0;i<fieldCards.size();++i) {
                ...
                if(isDef){
                    ...
                    auto mix = [](sf::Color a, sf::Color b){
                        return sf::Color(
                            static_cast<sf::Uint8>(std::min(255, (int(a.r)+int(b.r))/2)),
                            static_cast<sf::Uint8>(std::min(255, (int(a.g)+int(b.g))/2)),
                            static_cast<sf::Uint8>(std::min(255, (int(a.b)+int(b.b))/2)),
                            a.a
                        );
                    };
