...
**Adatto il main alla nuova logica**: Prima quando rilasciamo il click se ero in dragging calcolavo la posizione dello slot più vicino e se era libero (ed era valido) inserivo la carta nel vector fieldCard e la rilasciavo li la carta.
Adesso più o meno faccio la stessa cosa, ma quando rilascio la carta si avvia la normalSummon. Se la funzione tryNormalSummon ritorna     
