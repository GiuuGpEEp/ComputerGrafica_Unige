...
- handleEvent --> permette di gestire gli eventi che avvengono durante il gioco (es: pressione del tasto tab per cambiare fase del turno, oppure se sono nella mainPhase1 e si verifica un)    
