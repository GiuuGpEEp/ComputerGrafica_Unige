...
- All'interno di **Game**: Ho gestito la logica per implementare l'evocazione normale. 
    ...
    * Tra i parametri della classe ho aggiunto un vector monsterZone. Quando la normalSummon va a buon fine una carta viene spostata dalla mano alla  monsterZone. Ovviamente se 
