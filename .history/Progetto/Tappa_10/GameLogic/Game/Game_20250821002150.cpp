...
bool Game::canNormalSummon() const {
    ...
    return monsterZone.size() < MONSTER_ZONE_SIZE;
}
...
bool Game::tryNormalSummon(size_t handIndex){
    ...
    monsterZone.push_back(hand[handIndex]);
