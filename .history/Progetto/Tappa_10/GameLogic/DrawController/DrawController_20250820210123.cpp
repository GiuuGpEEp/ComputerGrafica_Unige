...
void DrawController::update(
    ...
    if (!animations.empty()) {
        DrawAnimationPhases ph = animations.front().update(MOVEMENT_SPEED_INTERNAL, deltaTime, textureFlipped, windowSize, cardSize, spacing, handY, handMaxSize, mousePressed, textureManager);
