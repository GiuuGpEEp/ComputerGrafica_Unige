...
Questa sottosezione riepiloga le modifiche più recenti fatte direttamente su `main.cpp` per ridurre duplicazione e snellire il wiring degli eventi; sono tutte piccole, locali e conservative rispetto all'architettura esistente (il `main` rimane proprietario delle risorse):
