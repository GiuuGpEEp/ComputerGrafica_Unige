...
static void registerDefaultEffects(Game &game){
...
// Create a new Game instance and attach controllers/resources. This centralizes the
// repetitive initialization logic used in multiple places in main.
static void createGameAndAttachResources(
                ...
                if(but == M_MOUSE_LEFT) {
                    ...
                    if(!inputBlocked() && gamestate == GameState::HomeScreen && homeScreen.getGiocaBounds().contains(initialMousePos)) {
                        if(selectedDeckName.empty()) {
                            ...
                            createGameAndAttachResources(selectedDeckName, deck, opponentDeck, resourceManager, game, drawController, aiP2, handPtr, p1STCards, p2STCards, p1FieldSpellCard, p2FieldSpellCard);
