...
const std::string& resourceBase = AppConfig::resourceBase;
const std::string& texturePath  = AppConfig::texturePath;
const std::string  deck1Path    = texturePath + "textureDeck1/";
const std::string& fontPath     = AppConfig::fontPath;
const std::string& cardsJsonPath = AppConfig::cardsJsonPath;
const std::string& decksJsonPath = AppConfig::decksJsonPath;
...
int main(){
    ...
    sf::Texture& fieldTexture = loadTexture(textureManager, texturePath + "backgroundTexture.png");
    sf::Texture& monsterTexture = loadTexture(textureManager, texturePath + "monsterText.png");
    sf::Texture& spellTrapTexture = loadTexture(textureManager, texturePath + "SpellTrapTexture.png");
    sf::Texture& deckTexture = loadTexture(textureManager, texturePath + "deckTexture.png");
    sf::Texture& graveyardTexture = loadTexture(textureManager, texturePath + "graveTexture.png");
    sf::Texture& extraDeckTexture = loadTexture(textureManager, texturePath + "ExtraDeckTexture.png");
    sf::Texture& fieldSpellTexture = loadTexture(textureManager, texturePath + "fieldSpell.png");
    sf::Texture& textureFlipped = loadTexture(textureManager, texturePath + "Texture1.png");
    sf::Texture& textureNonFlipped = loadTexture(textureManager, texturePath + "CardNotSet.jpg");
    sf::Texture& startScreenTexture = loadTexture(textureManager, texturePath + "startScreenTexture.png");
    sf::Texture& homeScreenTexture = loadTexture(textureManager, texturePath + "homeScreenTexture.png");
    sf::Texture& deckSelectionScreenTexture = loadTexture(textureManager, texturePath + "deckSelectionScreenTexture.png");

    // Carico il font per le etichette delle carte
    sf::Font detailFont;
    loadDetailFont(detailFont, fontPath);
