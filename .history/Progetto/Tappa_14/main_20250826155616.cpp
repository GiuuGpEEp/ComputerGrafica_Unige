...
int main(){
    ...
    sf::Texture& fieldTexture            = *tex[AppConfig::TextureKey::FieldBackground];
    sf::Texture& monsterTexture          = *tex[AppConfig::TextureKey::MonsterText];
    sf::Texture& spellTrapTexture        = *tex[AppConfig::TextureKey::SpellTrap];
    sf::Texture& deckTexture             = *tex[AppConfig::TextureKey::Deck];
    sf::Texture& graveyardTexture        = *tex[AppConfig::TextureKey::Graveyard];
    sf::Texture& extraDeckTexture        = *tex[AppConfig::TextureKey::ExtraDeck];
    sf::Texture& fieldSpellTexture       = *tex[AppConfig::TextureKey::FieldSpell];
    sf::Texture& textureFlipped          = *tex[AppConfig::TextureKey::CardBack];
    sf::Texture& textureNonFlipped       = *tex[AppConfig::TextureKey::CardFrontNotSet];
    sf::Texture& startScreenTexture      = *tex[AppConfig::TextureKey::StartScreen];
    sf::Texture& homeScreenTexture       = *tex[AppConfig::TextureKey::HomeScreen];
    sf::Texture& deckSelectionScreenTexture = *tex[AppConfig::TextureKey::DeckSelectionScreen];
