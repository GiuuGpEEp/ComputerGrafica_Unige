                ...
                if(deck.isAnimationFinished()) {
                    ...
                    if (deck.isShuffleAnimationAdvancedFinished()) {
                        ...
                        if(game && !game->isStarted()){
                            ...
                            appHandlersCtx.resetDeckPositions = [&](){ deck.resetDeckCardPositions(deckSlotPos, deckCardSize, slotSize, AppConfig::findTextureInMap(tex, AppConfig::TextureKey::CardBack)); 
