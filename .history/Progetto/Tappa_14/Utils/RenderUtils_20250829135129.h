...
// (helper rimosso per evitare dipendenze su Game/Field/Type nell'header)
...
// =====================
// Helper per il disegno in batch
// =====================
...
// Overlay di conferma per il ritorno alla Home (con hover dei pulsanti)
...
// Disegna il pannello dei dettagli usato dagli overlay (Extra/Graveyard)
