...
#include "Config.h"
// Use global helper to render the details panel
#include "auxFunc.h"
// Forward-declare Game and Field to allow sync helpers
...
// =====================
// Zone sync helpers (moved from main.cpp)
// =====================
