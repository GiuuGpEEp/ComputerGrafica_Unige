                    ...
                    if (deck.isShuffleAnimationAdvancedFinished()) {
                        ...
                        if(game && !game->isStarted()){
                            ...
                            // Prima sync completa delle zone
                                ...
                                appHandlersCtx.resetDeckPositions = [&](){ deck.resetDeckCardPositions(deckSlotPos, deckCardSize, slotSize, AppConfig::findTextureInMap(tex, AppConfig::TextureKey::CardBack)); opponentDeck.resetDeckCardPositions(deckSlotPosTop, deckCardSize, slotSize, AppConfig::findTextureInMap(tex, AppConfig::TextureKey::CardBack)); };
