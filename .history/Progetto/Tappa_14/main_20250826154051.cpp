...
int main(){
    ...
    // Preload delle texture più usate (rimane lazy-safe grazie al TextureManager)
    AppConfig::loadAllTextures(textureManager);
    sf::Texture& fieldTexture = textureManager.getTexture(AppConfig::texturePath + "backgroundTexture.png");
    sf::Texture& monsterTexture = textureManager.getTexture(AppConfig::texturePath + "monsterText.png");
    sf::Texture& spellTrapTexture = textureManager.getTexture(AppConfig::texturePath + "SpellTrapTexture.png");
    sf::Texture& deckTexture = textureManager.getTexture(AppConfig::texturePath + "deckTexture.png");
    sf::Texture& graveyardTexture = textureManager.getTexture(AppConfig::texturePath + "graveTexture.png");
    sf::Texture& extraDeckTexture = textureManager.getTexture(AppConfig::texturePath + "ExtraDeckTexture.png");
    sf::Texture& fieldSpellTexture = textureManager.getTexture(AppConfig::texturePath + "fieldSpell.png");
    sf::Texture& textureFlipped = textureManager.getTexture(AppConfig::texturePath + "Texture1.png");
    sf::Texture& textureNonFlipped = textureManager.getTexture(AppConfig::texturePath + "CardNotSet.jpg");
    sf::Texture& startScreenTexture = textureManager.getTexture(AppConfig::texturePath + "startScreenTexture.png");
    sf::Texture& homeScreenTexture = textureManager.getTexture(AppConfig::texturePath + "homeScreenTexture.png");
    sf::Texture& deckSelectionScreenTexture = textureManager.getTexture(AppConfig::texturePath + "deckSelectionScreenTexture.png");
