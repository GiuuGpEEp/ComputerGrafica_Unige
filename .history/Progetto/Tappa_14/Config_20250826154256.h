...
public:
    ...
    virtual void loadAllTextures(TextureManager& tm)for(const auto& path : textureFiles){
            tm.getTexture(path);
        };
    virtual void loadDetailFont(sf::Font& font, const std::string& primaryPath) = 0;
