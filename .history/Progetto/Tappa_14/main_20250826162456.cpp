...
int main(){
    ...
    HomePage homeScreen(window, detailFont, windowSize,
        AppConfig::findTextureInMap(textureManager, AppConfig::TextureKey::HomeScreen), deck.getDeckName());
    DeckSelectionScreen deckSelectionScreen(window, textureManager, resourceManager,
        AppConfig::findTextureInMap(textureManager, AppConfig::TextureKey::DeckSelectionScreen), windowSize, detailFont);
