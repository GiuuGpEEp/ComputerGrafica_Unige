...
bool Controller::handleEvent(const sf::Event& e){
    ...
    if(const auto* kp3 = e.getIf<sf::Event::KeyPressed>()){
        ...
        if(kp3->code == sf::Keyboard::Key::A && state.gamestate == GameState::Playing && !state.inputBlocked()){
        ...
        if(const auto* kp4 = e.getIf<sf::Event::KeyPressed>()){
            Game* game = state.getGame ? state.getGame() : nullptr;
            // Toggle posizione (C)
            if(kp4->code == sf::Keyboard::Key::C && state.gamestate == GameState::Playing && game && !state.inputBlocked() && !state.chooseSummonOrSet){
            ...
            if(kp4->code == sf::Keyboard::Key::X && state.gamestate == GameState::Playing && game && !state.inputBlocked()){
            ...
            if(state.chooseSummonOrSet && game && state.pendingHandIndexForPlay.has_value() && !state.inputBlocked()){
                if(kp4->code == sf::Keyboard::Key::E){
                    ...
                    return true;
                } else if(kp4->code == sf::Keyboard::Key::P){
            ...
            if(state.chooseActivateOrSetST && game && state.pendingHandIndexForPlay.has_value() && !state.inputBlocked()){
                if(kp4->code == sf::Keyboard::Key::A){
                    ...
                    return true;
                } else if(kp4->code == sf::Keyboard::Key::S){
