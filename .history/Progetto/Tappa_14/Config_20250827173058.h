...
namespace AppConfig {
    ...
    namespace Ui {
        ...
        // Deck visuals
        inline constexpr float DeckScaleFactor = 0.9f;        // visual size factor for deck stack

        // DeckSend overlay grid metrics
        inline constexpr float DeckSendScale = 0.7f;
        inline constexpr float DeckSendPad = 12.f;
        inline constexpr size_t DeckSendCols = 5;

        // Details panel (selected card / drawn card) absolute position and size
        ...
        // Overlay details panel (Extra/Graveyard) position as factors and fixed size
