...
Per ridurre ulteriormente la duplicazione e mantenere il refactor “mini”, i tre helper inizialmente locali sono stati spostati in `RenderUtils.h` come funzioni di rendering riutilizzabili:
