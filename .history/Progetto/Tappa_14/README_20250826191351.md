...
Per ridurre porzioni di codice duplicato nel rendering sono stati aggiunti helper in `Progetto/Tappa_14/RenderUtils.h` e adottati in `main.cpp`:
...
- Sync mostri P1/P2: centratura slot con `placeCentered`; difesa/FD con `placeRotatedDefense`; in piedi P1 con `setUpright`; P2 in piedi con `rotate180Centered`.
- Sync ST e FieldSpell: centratura con `placeCentered` (scale 0.70 e 0.78).
