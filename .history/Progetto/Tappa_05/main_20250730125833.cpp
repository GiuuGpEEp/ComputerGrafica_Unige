...
int main(){
    ...
    // Creo le carte del deck con posizioni pre-calcolate per l'effetto di impilamento
    for(int i = 0; i < 25; ++i) {
        ...
        // Applica l'offset per l'effetto di impilamento (carta 0 = top, carta 24 = bottom)
        sf::Vector2f offset(0.f, -1.f * (24 - i)); // Invertiamo l'ordine per avere la carta 0 in cima
    ...
    while(window.isOpen()){
        ...
        for(int i = 0; i < visibleCard; ++i) {
            sf::Vector2f offset(0.f, -1.f * i); // Offset dinamico per l'effetto di impilamento
