...
int main(){
    ...
    while(window.isOpen()){
        ...
        // Il disegno del testo relativo al numero di carte nel deck ha senso spostarlo dentro Deck::draw,
        // così la logica di rendering del deck (incluso il testo) resta incapsulata nella classe Deck.
        // Tuttavia, il controllo se il mouse è sopra il deck (deckArea.contains(mouseFloat)) 
        // e il passaggio della posizione del mouse dovrebbero essere gestiti in qualche modo:
        // puoi passare la posizione del mouse a Deck::draw oppure aggiungere un metodo tipo Deck::isHovered(mousePos).
        // Esempio di chiamata: deck.draw(window, mouseFloat); 
        // e dentro Deck::draw controlli se il mouse è sopra e disegni il testo.
        // Quindi sì, ha senso spostare questa logica dentro Deck::draw.
