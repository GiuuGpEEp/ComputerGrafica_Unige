...
int main(){
    ...
    // Creo le carte del deck (senza offset, solo posizione base)
    for(int i = 0; i < 25; ++i) {
        ...
        // Centra la carta scalata rispetto al centro dello slot (senza offset)
        sf::Vector2f centeredPos = slotCenter - sf::Vector2f(deckCardSize.x / 2.f, deckCardSize.y / 2.f);
