...
**Nota**: Siccome avere un unico file auxFunc condiviso per tutte le tappe ha dato problemi nella tappa 5 ho inserito un auxFunc.cpp e un auxFunc.h all'interno  
