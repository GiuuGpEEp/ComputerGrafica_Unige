...
void drawStartScreen(sf::RenderWindow& window, const sf::Font& font) {
    ...
    titleText.setPosition(sf::Vector2f((windowSize.x - titleBounds.width) / 2.0f, 50.0f));
    ...
    instructionsText.setPosition(sf::Vector2f((windowSize.x - instrBounds.width) / 2.0f, 150.0f));
