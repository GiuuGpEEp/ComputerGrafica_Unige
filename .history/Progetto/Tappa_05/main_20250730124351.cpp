...
int main(){
    ...
    // Creo le carte del deck con posizioni pre-calcolate
    for(int i = 0; i < 25; ++i) {
        // Calcola l'offset per questa carta specifica
        sf::Vector2f offset(0.f, -1.f * i);
        ...
        deck.emplace_back("Carta " + std::to_string(i + 1), "Descrizione della carta " + std::to_string(i + 1), 
                          1000, 800, centeredPos, deckCardSize, textureFlipped);
    }
