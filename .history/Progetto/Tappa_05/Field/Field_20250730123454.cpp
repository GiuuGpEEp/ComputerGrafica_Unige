        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    for (int i = 0; i < 3; ++i) {
        float x = mainStartX + i * (slotSize.x + spacing);
        slots.emplace_back(rotatedMonsterTexture, Slot::Type::Monster, slotSize);
        slots.back().setPosition(sf::Vector2f(x, p2SpellY));
    }
    ...
    for (int i = 0; i < 3; ++i) {
        float x = mainStartX + i * (slotSize.x + spacing);
        slots.emplace_back(rotatedSpellTrapTexture, Slot::Type::SpellTrap, slotSize);
        slots.back().setPosition(sf::Vector2f(x, p2MonsterY));
    }
    ...
    slots.emplace_back(graveyardTexture, Slot::Type::Graveyard, slotSize);
    slots.back().setPosition(sf::Vector2f(rightX, p1MonsterY));
    slots.emplace_back(deckTexture, Slot::Type::Deck, slotSize);
    slots.back().setPosition(sf::Vector2f(rightX, p1SpellY));
    ...
    slots.emplace_back(rotatedExtraDeckTexture, Slot::Type::Extra, slotSize);
    slots.back().setPosition(sf::Vector2f(rightX, p2MonsterY));
    slots.emplace_back(rotatedFieldSpellTexture, Slot::Type::FieldSpell, slotSize);
    slots.back().setPosition(sf::Vector2f(rightX, p2SpellY));

    // Extra Deck e Field Spell a sinistra
    slots.emplace_back(fieldSpellTexture, Slot::Type::FieldSpell, slotSize);
    slots.back().setPosition(sf::Vector2f(leftX, p1MonsterY));
    slots.emplace_back(extraDeckTexture, Slot::Type::Extra, slotSize);
    slots.back().setPosition(sf::Vector2f(leftX, p1SpellY));
    ...
    slots.emplace_back(rotatedDeckTexture, Slot::Type::Deck, slotSize);
    slots.back().setPosition(sf::Vector2f(leftX, p2MonsterY));
    slots.emplace_back(rotatedGraveyardTexture, Slot::Type::Graveyard, slotSize);
    slots.back().setPosition(sf::Vector2f(leftX, p2SpellY));
}
