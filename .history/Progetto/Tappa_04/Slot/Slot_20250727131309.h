...
public:
    ...
    Slot(sf::Vector2f position, const sf::Texture& texture, Type type, const sf::Vector2f& size, const sf::Transform& transform);
...
private:
    sf::Transform transform; // Aggiunta della trasformazione
    sf::Sprite sprite;
    bool occupied = false;
    Type type;
};
