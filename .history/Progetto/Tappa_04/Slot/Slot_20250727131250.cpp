...
Slot::Slot(sf::Vector2f position, const sf::Texture& textureRef, Type type, const sf::Vector2f& size, const sf::Transform& transform)
    : sprite(textureRef), type(type), transform(transform)
