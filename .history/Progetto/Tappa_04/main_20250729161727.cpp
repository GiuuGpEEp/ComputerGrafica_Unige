...
int main(){
    ...
    deck.reserve(30);
    // Ottieni la posizione dello slot deck del giocatore 1 (default)
    sf::Vector2f deckSlotPos = field.getSlotPosition(Slot::Type::Deck, 1); 
    // Per il giocatore 2: field.getSlotPosition(Slot::Type::Deck, 2); 
