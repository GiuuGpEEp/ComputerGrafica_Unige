        ...
        ) : background(fieldTexture), windowSize(windowSize)
{
    ...
    // L'ultimo valore è l'offset percentuale che ho ridotto per avvicinare le 2 metà campo
    float zoneOffset = calculateZoneOffset(windowSize, slotSize, spacing, 0.02f);
