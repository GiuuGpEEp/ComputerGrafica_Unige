...
int main(){
    ...
    sf::Vector2f pos(startX + 4 * (cardSize.x + spacing), y);
        cards.emplace_back("Drago Bianco", "Drago Bianco", "Questo drago leggendario e' una potente macchina distruttrice. Virtualmente invincibile, sono in pochi ad aver fronteggiato questa creatura ed essere sopravvissuti per raccontarlo.", 
                           3000, 800, pos, cardSize, textureNonFlipped);
