...
- GameWiring/
  - “Collante” tra app e motore (`Game`). Istanzia il Game, collega gli handler degli eventi, sincronizza stato logico ↔ UI (apertura prompt, overlay, aggiornamento grafico).
