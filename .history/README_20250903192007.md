...
- GameWiring/
  - Inizializza il Game per la logica di gioco, collegando gli handler degli eventi, sincronizza stato logico ↔ UI (apertura prompt, overlay, aggiornamento grafico).
